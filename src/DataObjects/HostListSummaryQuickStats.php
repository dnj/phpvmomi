...
{
	/**
	 * @var int $availablePMemCapacity The available capacity in MB.
	 */
	public $availablePMemCapacity;

	/**
	 * @var int $distributedCpuFairness The fairness of distributed CPU resource allocation on the host.
	 */
	public $distributedCpuFairness;

	/**
	 * @var int $distributedMemoryFairness The fairness of distributed memory resource allocation on the host.
	 */
	public $distributedMemoryFairness;

	/**
	 * @var int $overallCpuUsage Aggregated CPU usage across all cores on the host in MHz. This is only available if the host is connected.
	 */
	public $overallCpuUsage;

	/**
	 * @var int $overallMemoryUsage Physical memory usage on the host in MB. This is only available if the host is connected.
	 */
	public $overallMemoryUsage;

	/**
	 * @var int $uptime The system uptime of the host in seconds.
	 */
	public $uptime;
