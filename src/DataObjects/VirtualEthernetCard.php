...
class VirtualEthernetCard extends VirtualDevice
{
    ...
    /**
     * @var string An ID assigned to the virtual network adapter by external management plane or controller.
    ...
    /**
     * @var string MAC address assigned to the virtual network adapter.
    ...
    /**
     * @var VirtualEthernetCardResourceAllocation Resource requirements of the virtual network adapter
     *
     * @since vSphere API 6.0
     */
    ...
    /**
     * @var bool Indicates whether UPT(Universal Pass-through) compatibility is enabled on this network adapter.
    ...
    /**
     * @var bool Indicates whether wake-on-LAN is enabled on this virtual network adapter. Clients can set this property to selectively enable or disable wake-on-LAN.
     */
