...
class PropertyFilter
{
	...
	/**
	 * @var boolean $partialUpdates Flag to indicate if a change to a nested property reports only the nested change or the entire specified property value. If the value is true, a change reports only the nested property. If the value is false, a change reports the enclosing property named in the filter.
	 */
	public $partialUpdates;


	/**
	 * @var PropertyFilterSpec $spec Specifications for this filter. 
	 */
	public $spec;
}
